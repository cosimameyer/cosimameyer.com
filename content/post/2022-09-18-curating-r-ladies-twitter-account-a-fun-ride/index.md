---
title: Curating R-Ladies' Twitter Account - A Fun Ride!
author: 'Cosima'
date: '2022-09-18'
slug: curating-r-ladies-twitter-account-a-fun-ride
category: [R, R-post]
postImage: images/single-blog/wearerladies.png
featureImage: images/single-blog/wearerladies.png
---

I had an incredible pleasure (and honor) to curate [R-Ladies' Twitter account](https://twitter.com/WeAreRLadies) this week. To make it short: It's been a blast and a fantastic experience that I can only recommend! 

If you are interested, there are multiple posts that I all read beforehand about what it is like to be a curator (for instance by [Nicola Rennie](https://nrennie.rbind.io/blog/2022-01-18-curating-for-wearerladies/), [Shannon Pileggi](https://www.pipinghotdata.com/posts/2021-09-23-curating-for-wearerladies-on-twitter/) or [Divya Seernani](https://tolerancetoambiguity.com/my-week-with-we-are-r-ladies/)). They are great blog posts with a depth of collected knowledge and perspectives in them. 
...
{{< statictweet "1569559364314300416" >}}
...
So, if you want to get retweeted and future [@WeAreRLadies curators](https://bit.ly/how-git-works) have a similar setup as I had, it's best to tag your tweet with `#rladies` because it's difficult to find specific accounts on TweetDeck. 
